...
class NewsletterApi
{
     ...
     */
    public function unfollowNewsletter($x_device_id = null, $unfollow_newsletter_request = null, string $contentType = self::contentTypes['unfollowNewsletter'][0])
    {
        list($response) = $this->unfollowNewsletterWithHttpInfo($x_device_id, $unfollow_newsletter_request, $contentType);
        return $response;
    }
     ...
     */
    public function unfollowNewsletterWithHttpInfo($x_device_id = null, $unfollow_newsletter_request = null, string $contentType = self::contentTypes['unfollowNewsletter'][0])
    {
        $request = $this->unfollowNewsletterRequest($x_device_id, $unfollow_newsletter_request, $contentType);
     ...
     */
    public function unfollowNewsletterAsync($x_device_id = null, $unfollow_newsletter_request = null, string $contentType = self::contentTypes['unfollowNewsletter'][0])
    {
        return $this->unfollowNewsletterAsyncWithHttpInfo($x_device_id, $unfollow_newsletter_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unfollowNewsletterAsyncWithHttpInfo($x_device_id = null, $unfollow_newsletter_request = null, string $contentType = self::contentTypes['unfollowNewsletter'][0])
    {
     ...
     */
    public function unfollowNewsletterRequest($x_device_id = null, $unfollow_newsletter_request = null, string $contentType = self::contentTypes['unfollowNewsletter'][0])
    {
