...
class UserApi
{
    ...
    public function userMyContactsWithHttpInfo(string $contentType = self::contentTypes['userMyContacts'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SdkWhatsappWebMultiDevice\Model\MyListContactsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SdkWhatsappWebMultiDevice\Model\MyListContactsResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SdkWhatsappWebMultiDevice\Model\MyListContactsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 500:
    ...
    public function userMyGroupsWithHttpInfo(string $contentType = self::contentTypes['userMyGroups'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SdkWhatsappWebMultiDevice\Model\UserGroupResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SdkWhatsappWebMultiDevice\Model\UserGroupResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SdkWhatsappWebMultiDevice\Model\UserGroupResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 500:
    ...
    public function userMyNewsletterWithHttpInfo(string $contentType = self::contentTypes['userMyNewsletter'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SdkWhatsappWebMultiDevice\Model\NewsletterResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SdkWhatsappWebMultiDevice\Model\NewsletterResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SdkWhatsappWebMultiDevice\Model\NewsletterResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 500:
