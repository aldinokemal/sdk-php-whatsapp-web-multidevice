...
/**
 * AddDeviceRequest Class Doc Comment
 *
 * @category Class
 * @package  SdkWhatsappWebMultiDevice
 * @author   OpenAPI Generator team
 ...
 */
class AddDeviceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'addDevice_request';
     ...
     * Sets device_id
     *
     * @param string|null $device_id Optional custom device ID. If not provided, one will be generated.
     *
     * @return self
     */
