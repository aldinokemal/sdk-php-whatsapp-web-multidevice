...
/**
 * SetGroupTopicRequest Class Doc Comment
 *
 * @category Class
 * @package  SdkWhatsappWebMultiDevice
 * @author   OpenAPI Generator team
 ...
 */
class SetGroupTopicRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'setGroupTopic_request';
    ...
    */
     ...
     * Sets topic
     *
     * @param string|null $topic The group topic/description. Leave empty to remove the topic.
     *
     * @return self
     */
