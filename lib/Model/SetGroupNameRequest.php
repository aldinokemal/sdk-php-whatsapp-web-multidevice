...
/**
 * SetGroupNameRequest Class Doc Comment
 *
 * @category Class
 * @package  SdkWhatsappWebMultiDevice
 * @author   OpenAPI Generator team
 ...
 */
class SetGroupNameRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'setGroupName_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name The new group name (max 25 characters)
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SetGroupNameRequest., must be smaller than or equal to 25.');
        }
