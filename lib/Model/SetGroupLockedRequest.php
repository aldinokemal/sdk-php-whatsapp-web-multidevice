...
/**
 * SetGroupLockedRequest Class Doc Comment
 *
 * @category Class
 * @package  SdkWhatsappWebMultiDevice
 * @author   OpenAPI Generator team
 ...
 */
class SetGroupLockedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'setGroupLocked_request';
    ...
    */
     ...
     * Sets locked
     *
     * @param bool $locked Whether to lock the group (true) or unlock it (false)
     *
     * @return self
     */
