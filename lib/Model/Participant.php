...
class Participant implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('add_request', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['add_request'];
    }

    /**
     * Sets add_request
     *
     * @param string|null $add_request add_request
     *
     * @return self
     */
    public function setAddRequest($add_request)
    {
        if (is_null($add_request)) {
            throw new \InvalidArgumentException('non-nullable add_request cannot be null');
        }
        $this->container['add_request'] = $add_request;
