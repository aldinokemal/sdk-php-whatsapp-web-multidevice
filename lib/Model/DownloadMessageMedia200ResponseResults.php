<?php
/**
 * DownloadMessageMedia200ResponseResults
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * DownloadMessageMedia200ResponseResults Class Doc Comment
 *
 * @category Class
 * @package  SdkWhatsappWebMultiDevice
 * @author   OpenAPI Generator team
 ...
 */
class DownloadMessageMedia200ResponseResults implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'downloadMessageMedia_200_response_results';
     ...
     * Sets data
     *
     * @param string|null $data Base64 encoded media data
     *
     * @return self
     */
