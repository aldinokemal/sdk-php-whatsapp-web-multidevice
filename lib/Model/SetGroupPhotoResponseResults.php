...
/**
 * SetGroupPhotoResponseResults Class Doc Comment
 *
 * @category Class
 * @package  SdkWhatsappWebMultiDevice
 * @author   OpenAPI Generator team
 ...
 */
class SetGroupPhotoResponseResults implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetGroupPhotoResponse_results';
    ...
    */
     ...
     * Sets picture_id
     *
     * @param string|null $picture_id The ID of the uploaded picture, or 'remove' if photo was removed
     *
     * @return self
     */
