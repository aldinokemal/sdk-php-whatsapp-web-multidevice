...
/**
 * AppStatus200ResponseResults Class Doc Comment
 *
 * @category Class
 * @package  SdkWhatsappWebMultiDevice
 * @author   OpenAPI Generator team
 ...
 */
class AppStatus200ResponseResults implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'appStatus_200_response_results';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_logged_in', $data ?? [], null);
     ...
     * Sets is_connected
     *
     * @param bool|null $is_connected Whether the device is connected to WhatsApp servers
     *
     * @return self
     */
     ...
     * Sets is_logged_in
     *
     * @param bool|null $is_logged_in Whether the device is logged in to WhatsApp
     *
     * @return self
     */
    public function setIsLoggedIn($is_logged_in)
    {
        if (is_null($is_logged_in)) {
            throw new \InvalidArgumentException('non-nullable is_logged_in cannot be null');
        }
     ...
     * Sets device_id
     *
     * @param string|null $device_id The device ID
     *
     * @return self
     */
