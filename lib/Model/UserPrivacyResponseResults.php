...
/**
 * UserPrivacyResponseResults Class Doc Comment
 *
 * @category Class
 * @package  SdkWhatsappWebMultiDevice
 * @author   OpenAPI Generator team
 ...
 */
class UserPrivacyResponseResults implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserPrivacyResponse_results';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('read_receipts', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets group_add
     *
     * @param string|null $group_add group_add
     *
     * @return self
     */
    ...
    {
        return $this->container['read_receipts'];
    }

    /**
     * Sets read_receipts
     *
     * @param string|null $read_receipts read_receipts
     *
     * @return self
     */
    public function setReadReceipts($read_receipts)
    {
        if (is_null($read_receipts)) {
            throw new \InvalidArgumentException('non-nullable read_receipts cannot be null');
        }
        $this->container['read_receipts'] = $read_receipts;
