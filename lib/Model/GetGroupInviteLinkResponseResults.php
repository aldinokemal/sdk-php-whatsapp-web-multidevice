...
/**
 * GetGroupInviteLinkResponseResults Class Doc Comment
 *
 * @category Class
 * @package  SdkWhatsappWebMultiDevice
 * @author   OpenAPI Generator team
 ...
 */
class GetGroupInviteLinkResponseResults implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetGroupInviteLinkResponse_results';
    ...
    */
     ...
     * Sets invite_link
     *
     * @param string|null $invite_link The group invite link
     *
     * @return self
     */
