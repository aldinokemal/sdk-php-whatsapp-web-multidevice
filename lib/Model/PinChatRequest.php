...
/**
 * PinChatRequest Class Doc Comment
 *
 * @category Class
 * @package  SdkWhatsappWebMultiDevice
 * @author   OpenAPI Generator team
 ...
 */
class PinChatRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pinChat_request';
    ...
    */
     ...
     * Sets pinned
     *
     * @param bool $pinned Whether to pin (true) or unpin (false) the chat
     *
     * @return self
     */
